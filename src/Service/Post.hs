      ...
      case post of
        Just p -> return $ Right $
          Post {
            ...
            , unPostOgImg = tblPostOgImg p
            , unPostOgTitle = tblPostOgTitle p
            , unPostOgUrl = tblPostOgUrl p
            , unPostOgSiteName = tblPostOgSiteName p
            , unPostOgDesc = tblPostOgDesc p
...
registerPost usrKey post = runDB $ do
  ...
  TblPostKey (SqlBackendKey postId) <- insert $
    TblPost {
      ...
      , tblPostOgImg = unPostOgImg post
      , tblPostOgTitle = unPostOgTitle post
      , tblPostOgUrl = unPostOgUrl post
