...
var $author$project$Preview$RandVal = function (a) {
	return {$: 'RandVal', a: a};
};
			...
			case 'HResp':
				if (msg.a.$ === 'Ok') {
					...
					return (res.result === 1) ? _Utils_Tuple2(
						...
						A2(
							$elm$random$Random$generate,
							$author$project$Preview$RandVal,
							A2($elm$random$Random$int, 1, 1000000))) : _Utils_Tuple2(
						model,
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Preview$switchUrl(model.prevtype) + ('?n=' + $elm$core$String$fromInt(model.randnum))),
